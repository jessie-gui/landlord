...
function openConnection(){
        ...
        ws = new WebSocket("ws://localhost:8080/open");
            ...
            switch(data.MsgType){
                ...
                case MSG_TYPE_OF_SEND_CARD:
                    ...
                    $.each(data.Cards,function(i,o){
                        $("#userCards").prepend(String.format($("#tempPlayCard").html(),o.Name,o.Suit,o.Index));
                    })
                    break;
                ...
                case TYPE_OF_TABLE_BRODCAST:
                    switch(data.SubMsgType){
                        ...
                        case MSG_TYPE_OF_JOIN_TABLE:
                            $("#rightPlayer").html('');
                            $("#leftPlayer").html('');
                            console.log(data.PlayerIndexIdDic);
                        ...
                        case MSG_TYPE_OF_SEND_BOTTOM_CARDS:
                            $.each(data.Cards,function(i,o){
                                $("#userCards").append(String.format($("#tempCard").html(),o.Name,o.Suit));
                            })
                            $("#divPlay").show();
                            break;
                        case MSG_TYPE_OF_PLAY_CARD:
                            ...
                            $("#divPlayCards").html('');
                            $.each(data.Cards,function(i,o){
                                $("#divPlayCards").append(String.format($("#tempCard").html(),o.Name,o.Suit));
                            })
...
function unReady(){
    var readyMsg = {}
    readyMsg.MsgType = MSG_TYPE_OF_UN_READY;
    ws.send(JSON.stringify(readyMsg));
    print("UNREADY")
}
